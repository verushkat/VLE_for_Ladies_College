 ...
 */
export declare class SwalComponent implements OnInit, OnChanges, OnDestroy {
    ...
    */
    ...
    constructor(sweetAlert2Loader: SweetAlert2LoaderService, moduleLevelDismissOnDestroy: boolean);
    /**
