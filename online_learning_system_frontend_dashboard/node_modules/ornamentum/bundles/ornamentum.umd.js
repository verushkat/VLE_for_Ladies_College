    ...
    ***************************************************************************** */
    ...
    var DataTableColumnFilterHeaderComponent = /** @class */ (function () {
        function DataTableColumnFilterHeaderComponent(config, eventStateService) {
            this.config = config;
            this.eventStateService = eventStateService;
            this.columnFilterStream = new rxjs.Subject();
            this.customFilterStream = new core.EventEmitter();
        }
        /**
         * Component initialize lifecycle event handler.
         */
        ...
        function () {
            var _this = this;
            this.columnFilterSubscription = this.columnFilterStream.pipe(operators.debounceTime(this.config.filterDebounceTime)).subscribe((/**
             * @return {?}
             */
            function () {
    ...
    var DataTableScrollPositionService = /** @class */ (function () {
        function DataTableScrollPositionService() {
            this.scrollPositionStream = new rxjs.Subject();
        }
    ...
    var DataTableColumnFilterTemplateComponent = /** @class */ (function () {
        function DataTableColumnFilterTemplateComponent(config, dataStateService, eventStateService, scrollPositionService) {
            ...
            this.filterDataStream = new rxjs.Subject();
        }
        /**
        ...
        DataTableColumnFilterTemplateComponent.propDecorators = {
            ...
            customFilterStream: [{ type: core.Input }],
    ...
    var ResizeService = /** @class */ (function () {
        function ResizeService(globalRefService) {
            ...
            if (this.globalRefService.isBrowser) {
                this.resize = rxjs.fromEvent(this.globalRefService.window, 'resize');
            }
            else {
    ...
    PopoverComponentLoader = /** @class */ (function () {
        ...
        function (parentElement, options) {
            ...
            this.resizeEventSubscription = this.resizeService.resize.pipe(operators.take(1)).subscribe((/**
             * @return {?}
             */
            function () {
                _this.hide();
    ...
    var DataTablePaginationComponent = /** @class */ (function () {
        ...
        function () {
            ...
            this.resizeService.resize.pipe(operators.debounceTime(200)).subscribe((/**
             * @return {?}
             */
            function () {
        ...
        DataTablePaginationComponent.propDecorators = {
            paginationContainer: [{ type: core.ViewChild, args: ['paginationContainer', { static: true },] }]
        };
    ...
    var DataTableResourceService = /** @class */ (function () {
        ...
        function (dataSource) {
            ...
            this.itemDataStream = new rxjs.ReplaySubject(1);
         ...
         */
        function (params) {
            return this.itemDataStream.pipe(operators.switchMap((/**
             * @param {?} items
             * @return {?}
             */
            function (items) {
    ...
    var DataTableComponent = /** @class */ (function () {
        ...
        function () {
            ...
            this.dataFetchStreamSubscription = this.eventStateService.dataFetchStream
                .pipe(operators.debounceTime(20), operators.switchMap((/**
             * @param {?} fetchMode
             * @return {?}
             */
            function (fetchMode) { return _this.mapDataBind(fetchMode); })), operators.catchError((/**
             * @return {?}
             */
            function () {
                return rxjs.of(noop);
        ...
        DataTableComponent.propDecorators = {
            columns: [{ type: core.ContentChildren, args: [DataTableColumnComponent,] }],
            rowExpandTemplate: [{ type: core.ContentChild, args: ['ngDataTableRowExpand', { static: true },] }],
            noRecordsTemplate: [{ type: core.ContentChild, args: ['ngDataTableNoRecords', { static: true },] }],
            loadingSpinnerTemplate: [{ type: core.ContentChild, args: ['ngDataTableLoadingSpinner', { static: true },] }],
            rowExpandLoadingSpinnerTemplate: [{ type: core.ContentChild, args: ['ngDataTableRowExpandLoadingSpinner', { static: true },] }],
            dataTableElement: [{ type: core.ViewChild, args: ['dataTableElement', { static: true },] }],
            ...
            allRowSelectChange: [{ type: core.Output }],
            cellClick: [{ type: core.Output }],
            dataBound: [{ type: core.Output }],
            rowBind: [{ type: core.Output }],
            columnBind: [{ type: core.Output }],
            cellBind: [{ type: core.Output }],
            onDataBind: [{ type: core.Input }],
            onFilterValueExtract: [{ type: core.Input }],
            onDynamicRowSpanExtract: [{ type: core.Input }],
            items: [{ type: core.Input }],
            dataSource: [{ type: core.Input }],
            id: [{ type: core.Input }],
            persistTableState: [{ type: core.Input }],
            storageMode: [{ type: core.Input }],
            multiColumnSortable: [{ type: core.Input }],
            showHeader: [{ type: core.Input }],
            title: [{ type: core.Input }],
            width: [{ type: core.Input }],
            minContentHeight: [{ type: core.Input }],
            minContentWidth: [{ type: core.Input }],
            contentHeight: [{ type: core.Input }],
            pageable: [{ type: core.Input }],
            loadOnScroll: [{ type: core.Input }],
            loadViewDistanceRatio: [{ type: core.Input }],
            showIndexColumn: [{ type: core.Input }],
            indexColumnTitle: [{ type: core.Input }],
            rowSelectable: [{ type: core.Input }],
            selectMode: [{ type: core.Input }],
            showRowSelectCheckbox: [{ type: core.Input }],
            showRowSelectAllCheckbox: [{ type: core.Input }],
            showSubstituteRows: [{ type: core.Input }],
            expandableRows: [{ type: core.Input }],
            selectOnRowClick: [{ type: core.Input }],
            expandOnRowClick: [{ type: core.Input }],
            autoFetch: [{ type: core.Input }],
            showLoadingSpinner: [{ type: core.Input }],
            selectTrackBy: [{ type: core.Input }],
            selectedRow: [{ type: core.Input }],
            selectedRows: [{ type: core.Input }],
            filterDebounceTime: [{ type: core.Input }],
            filterDebounce: [{ type: core.Input }],
            showRefreshButton: [{ type: core.Input }],
            showColumnSelector: [{ type: core.Input }],
            columnSelectorWidth: [{ type: core.Input }],
            expanderColumnWidth: [{ type: core.Input }],
            indexColumnWidth: [{ type: core.Input }],
            selectionColumnWidth: [{ type: core.Input }],
            translations: [{ type: core.Input }],
            showRowExpandLoadingSpinner: [{ type: core.Input }],
    ...
    var DataTableBodyComponent = /** @class */ (function () {
        ...
        DataTableBodyComponent.propDecorators = {
            ...
            rowExpandLoadingSpinnerTemplate: [{ type: core.Input }]
        };
    ...
    var DataTableNoDataBodyComponent = /** @class */ (function () {
        ...
        DataTableNoDataBodyComponent.propDecorators = {
            noRecordsTemplate: [{ type: core.Input }]
        };
    ...
    var DataTableLoadingSpinnerComponent = /** @class */ (function () {
        ...
        DataTableLoadingSpinnerComponent.propDecorators = {
            loadingSpinnerTemplate: [{ type: core.Input }],
    ...
    var ScrollPositionDirective = /** @class */ (function () {
        ...
        function () {
             ...
             */
            function () {
                _this.scrollEventSubscription = rxjs.fromEvent(_this.el.nativeElement, 'scroll')
                    .pipe(operators.map((/**
                 * @return {?}
                 */
                function () {
                ...
                })), operators.pairwise(), operators.map((/**
                 * @param {?} pair
                 * @return {?}
                 */
                function (pair) {
        ...
        ScrollPositionDirective.propDecorators = {
            ngScrollPosition: [{ type: core.Input }]
        };
    ...
    var ScrollElementDirective = /** @class */ (function () {
        ...
        ScrollElementDirective.propDecorators = {
            ngScrollElement: [{ type: core.Input }]
        };
    ...
    var ElementWidthDirective = /** @class */ (function () {
        function ElementWidthDirective(el) {
            this.el = el;
            this.ngElementWidth = new core.EventEmitter();
        }
        /**
        ...
        ElementWidthDirective.propDecorators = {
            ngElementWidth: [{ type: core.Output }]
        };
     ...
     */
    /** @type {?} */
    var DROPDOWN_CONFIG = new core.InjectionToken('dropdownConfig');
    /**
    ...
    var DropdownConfigService = /** @class */ (function () {
        ...
        DropdownConfigService.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Inject, args: [DROPDOWN_CONFIG,] }] }
        ]; };
    ...
    var DropdownEventStateService = /** @class */ (function () {
        function DropdownEventStateService() {
            this.dataFetchStream = new core.EventEmitter();
            this.dataBoundStream = new core.EventEmitter();
            this.selectChangeStream = new core.EventEmitter();
            this.initStream = new core.EventEmitter();
            this.staticDataSourceStream = new rxjs.ReplaySubject(1);
        }
    ...
    var DropdownViewComponent = /** @class */ (function () {
        ...
        function () {
            var _this = this;
            this.scrollEventSubscription = this.scrollEvent.pipe(operators.debounceTime(100)).subscribe((/**
             * @param {?} event
             * @return {?}
             */
            function (event) {
    ...
    var DropdownResourceService = /** @class */ (function () {
        ...
        function (dataSource) {
            ...
            this.optionDataStream = new rxjs.ReplaySubject(1);
            this.dataSourceSubscription = dataSource.subscribe((/**
             * @param {?} options
             * @return {?}
             */
         ...
         */
        function (params) {
            return this.optionDataStream.pipe(operators.switchMap((/**
             * @param {?} options
             * @return {?}
             */
            function (options) {
    ...
    var DropdownComponent = /** @class */ (function () {
        ...
        function () {
             ...
             * @return {?}
             */
            function (hardReload) { return _this.fetchQueryResults(hardReload); })), operators.catchError((/**
             * @return {?}
             */
            function () {
                return rxjs.of(noop);
        ...
        DropdownComponent.propDecorators = {
            loadingSpinnerTemplate: [{ type: core.ContentChild, args: ['ngDropdownLoadingSpinner', { static: true },] }],
            optionTemplate: [{ type: core.ContentChild, args: ['ngDropdownOption', { static: true },] }],
            optionGroupHeaderTemplate: [{ type: core.ContentChild, args: ['ngDropdownOptionGroupHeader', { static: true },] }],
            init: [{ type: core.Output }],
            selectChange: [{ type: core.Output }],
            dataBound: [{ type: core.Output }],
            onDataBind: [{ type: core.Input }],
            loadingSpinnerTemplateRef: [{ type: core.Input }],
            optionTemplateRef: [{ type: core.Input }],
            optionGroupHeaderTemplateRef: [{ type: core.Input }],
            options: [{ type: core.Input }],
            dataSource: [{ type: core.Input }],
            id: [{ type: core.Input }],
            translations: [{ type: core.Input }],
            selectTrackBy: [{ type: core.Input }],
            displayTrackBy: [{ type: core.Input }],
            groupByField: [{ type: core.Input }],
            disabledTrackBy: [{ type: core.Input }],
            selectedOptions: [{ type: core.Input }],
            selectedOption: [{ type: core.Input }],
            limit: [{ type: core.Input }],
            wrapDisplaySelectLimit: [{ type: core.Input }],
            loadOnScroll: [{ type: core.Input }],
            loadViewDistanceRatio: [{ type: core.Input }],
            selectMode: [{ type: core.Input }],
            filterable: [{ type: core.Input }],
            ...
            filterDebounce: [{ type: core.Input }],
            filterDebounceTime: [{ type: core.Input }],
            loadDataOnInit: [{ type: core.Input }],
            showSelectedOptionRemoveButton: [{ type: core.Input }],
            showClearSelectionButton: [{ type: core.Input }],
            menuWidth: [{ type: core.Input }],
            menuHeight: [{ type: core.Input }],
            menuPosition: [{ type: core.Input }],
            disabled: [{ type: core.Input }],
            closeMenuOnSelect: [{ type: core.Input }],
            showOptionSelectCheckbox: [{ type: core.Input }],
            showOptionIndex: [{ type: core.Input }],
            showOptionTrackBy: [{ type: core.Input }],
            multiSelectOptionMaxWidth: [{ type: core.Input }],
            setFirstOptionSelected: [{ type: core.Input }],
            triggerSelectChangeOnInit: [{ type: core.Input }],
            triggerSelectChangeOnModelUpdate: [{ type: core.Input }],
            triggerSelectChangeOnFirstOptionSelect: [{ type: core.Input }],
            dynamicDimensionCalculation: [{ type: core.Input }],
            dynamicWidthRatio: [{ type: core.Input }],
            dynamicHeightRatio: [{ type: core.Input }],
            relativeParentElement: [{ type: core.Input }]
        };
    ...
    var DropdownFilterComponent = /** @class */ (function () {
        function DropdownFilterComponent(config, dataStateService, eventStateService) {
            ...
            this.dataStateService = dataStateService;
            this.eventStateService = eventStateService;
            this.dataFilterStream = new rxjs.Subject();
        }
        /**
        ...
        function () {
            var _this = this;
            this.dataFilterSubscription = this.dataFilterStream.pipe(operators.debounceTime(this.config.filterDebounceTime)).subscribe((/**
             * @return {?}
             */
            function () {
    ...
    var DropdownModule = /** @class */ (function () {
        ...
        DropdownModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, forms.FormsModule, UtilityModule.forRoot()],
    ...
    var DataTableModule = /** @class */ (function () {
        ...
        DataTableModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, forms.FormsModule, UtilityModule.forRoot(), DropdownModule.forRoot()],
    ...
    var RequestParamMapperService = /** @class */ (function () {
        ...
        function (requestOptions) {
            if (requestOptions && requestOptions.params) {
                if (requestOptions.params instanceof http.HttpParams) {
    ...
    DataTableWebsocketDataFetchService = /** @class */ (function () {
         ...
         */
        function (config) {
            this.socket = webSocket.webSocket(config);
    ...
    exports.DataFetchMode = DataFetchMode;
    exports.DataTableColumnComponent = DataTableColumnComponent;
    exports.DataTableComponent = DataTableComponent;
    exports.DataTableHttpDataFetchService = DataTableHttpDataFetchService;
    exports.DataTableHttpResourceFactoryService = DataTableHttpResourceFactoryService;
    exports.DataTableModule = DataTableModule;
    exports.DataTableResourceModule = DataTableResourceModule;
    exports.DataTableWebsocketDataFetchService = DataTableWebsocketDataFetchService;
    exports.DataTableWebsocketResourceFactoryService = DataTableWebsocketResourceFactoryService;
    exports.DragAndDropService = DragAndDropService;
    exports.DropdownComponent = DropdownComponent;
    exports.DropdownHttpDataFetchService = DropdownHttpDataFetchService;
    exports.DropdownHttpResourceFactoryService = DropdownHttpResourceFactoryService;
    exports.DropdownModule = DropdownModule;
    exports.DropdownResourceModule = DropdownResourceModule;
    exports.DropdownWebsocketDataFetchService = DropdownWebsocketDataFetchService;
    exports.DropdownWebsocketResourceFactoryService = DropdownWebsocketResourceFactoryService;
    exports.GlobalRefService = GlobalRefService;
    exports.PopoverComponentLoader = PopoverComponentLoader;
    exports.PopoverComponentLoaderFactoryService = PopoverComponentLoaderFactoryService;
    exports.RequestParamMapperService = RequestParamMapperService;
    exports.ResourceUtilityModule = ResourceUtilityModule;
    exports.UtilityConfigService = UtilityConfigService;
    exports.UtilityModule = UtilityModule;
    exports.ɵa = InitDirective;
    exports.ɵb = FocusDirective;
    exports.ɵba = DataTableNoDataBodyComponent;
    exports.ɵbb = DataTableColumnFilterHeaderComponent;
    exports.ɵbc = DataTableColumnFilterTemplateComponent;
    exports.ɵbd = DataTableColumnTitleHeaderComponent;
    exports.ɵbe = DataTableHeadComponent;
    exports.ɵbf = DataTableLoadingSpinnerComponent;
    exports.ɵbg = ScrollPositionDirective;
    exports.ɵbh = ScrollElementDirective;
    exports.ɵbi = ElementWidthDirective;
    exports.ɵbj = ResourceUtilityConfigService;
    exports.ɵbk = DataTableResourceConfigService;
    exports.ɵbl = DropdownResourceConfigService;
    exports.ɵc = PixelConverterPipe;
    exports.ɵd = ResizeService;
    exports.ɵe = ValidatorService;
    exports.ɵf = DROPDOWN_CONFIG;
    exports.ɵg = DropdownConfigService;
    exports.ɵh = DropdownDataStateService;
    exports.ɵi = DropdownEventStateService;
    exports.ɵj = DropdownResourceService;
    exports.ɵk = DropdownViewComponent;
    exports.ɵl = DropdownFilterComponent;
    exports.ɵm = DropdownOptionsComponent;
    exports.ɵn = DataTableHeaderComponent;
    exports.ɵo = DataTableEventStateService;
    exports.ɵp = DataTableDataStateService;
    exports.ɵq = DATA_TABLE_CONFIG;
    exports.ɵr = DataTableConfigService;
    exports.ɵt = DataTableColGroupComponent;
    exports.ɵu = DataTableBodyComponent;
    exports.ɵv = DataTablePaginationComponent;
    exports.ɵw = DataTablePersistenceService;
    exports.ɵx = DataTableScrollPositionService;
    exports.ɵy = DataTableResourceService;
    exports.ɵz = DataTableColumnSelectorComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=ornamentum.umd.js.map
